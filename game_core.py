...
from constants import SCREEN_WIDTH, SCREEN_HEIGHT, WINDOWS_SIZE, TILE_SIZE, GREEN, BLUEBLACK, BLUE, RED, PLAYER_OFFSET
...
class CoinFlipTedScreen(Screen):
    ...
    def draw(self, state: "GameState"):
        ...
        state.DISPLAY.blit(
            ...
            (10, 10))
        state.DISPLAY.blit(self.font.render(f"{self.second_message_display}", True,
                                      (255, 255, 255)), (10, 50))
        state.DISPLAY.blit(self.font.render(f"{self.third_message_display}", True,
                                      (255, 255, 255)), (10, 230))
        state.DISPLAY.blit(self.font.render(f"Your current bet is:{self.bet}", True,
                                      (255, 255, 255)), (10, 260))
        state.DISPLAY.blit(

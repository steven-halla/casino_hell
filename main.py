...
class Player(Entity):
    def __init__(self, x: float, y: float):
        ...
        self.walk_speed = 3.5
        self.money = 5000
        self.image = pygame.image.load("/Users/stevenhalla/code/nfeGame/images/player_walk_0.png")
...
class MainScreen(Screen):
    ...
    def __init__(self):
        ...
        self.tiled_map = pytmx.load_pygame("/Users/stevenhalla/documents/images/casinomaingame.tmx")

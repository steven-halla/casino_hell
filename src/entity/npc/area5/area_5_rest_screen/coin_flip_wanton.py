...
class CoinFlipWanton(Npc):
    ...
    def update_waiting(self, state: "GameState"):
        ...
        if (distance < 40 and state.controller.confirm_button and \
            ...
            if Events.COIN_FLIP_WANTON_DEFEATED.value in state.player.level_five_npc_state:
    ...
    def update_talking(self, state: "GameState"):
        ...
        if (current_message.is_finished() and Events.COIN_FLIP_WANTON_DEFEATED.value

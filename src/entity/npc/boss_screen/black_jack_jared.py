...
class BlackJackJared(Npc):
    def __init__(self, x: int, y: int):
        super().__init__(x, y)
        self.selected_item_index = 0
        self.black_jack_thomas_messages = {
            "welcome_message": NpcTextBox(
                ["Jared: You may think your ready for me, but your not , better be careful", "Are you ready to lose?!"],
        ...
        self.character_sprite_image = pygame.image.load("./assets/images/SNES - Harvest Moon - Hawker and Peddler ALPHA.png").convert_alpha()

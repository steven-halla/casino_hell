...
class Area4BarKeep(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.shop_items = [
            "Hoppy Brew", "Carrion Nachos","Barf Soup", "horse swimmers", "Body Feast",
            "Mind Feast", "Spirit Feast", "Luck Feast", "Perception Feast"
        ]
        self.shop_costs = ["200", "200", "200", "500","300", "500", "500", "500", "500"]
    ...
    def update(self, state: "GameState"):
        if self.state == "waiting":
            ...
            if state.controller.isTPressed and state.player.food > 0:
                ...
                elif idx == 3 and state.player.food > 3:
                    self.buy_sound.play()
                    state.player.money -= 200
                    state.player.focus_points += 200

                    state.player.food -= 3

                elif idx in range(4, 9) and Events.FEAST_CONSUMED.value not in state.player.level_four_npc_state:
                    eligible = [
                        state.player.body,
                        state.player.mind,
                        state.player.spirit,
    ...
    def draw(self, state):
        ...
        if self.state == "talking":
            ...
            if self.selected_item_index == 0:
                ...
                state.DISPLAY.blit(self.font.render("made from vomit that is pure.", True, (255, 255, 255)),
                                   (70, 460))
                state.DISPLAY.blit(self.font.render(" adds +1 spirit.", True, (255, 255, 255)), (70, 510))

            elif self.selected_item_index == 3:
                state.DISPLAY.blit(self.font.render("made from horsers that can swim.", True, (255, 255, 255)),
                                   (70, 460))
                state.DISPLAY.blit(self.font.render(" adds 200 MP beyond the max.", True, (255, 255, 255)), (70, 510))
                ...
                idx = self.selected_item_index - 4
                if feast_bought or stat_values[idx] == 4:

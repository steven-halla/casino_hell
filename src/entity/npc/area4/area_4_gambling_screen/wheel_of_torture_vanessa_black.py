...
class WheelOfTortureVanessaBlack(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.wheel_of_torture_vanessa_black_messages = {
            "welcome_message": NpcTextBox(
                ["Vanessa black: Are you sure you want to play wheel of tortre?"],
    ...
    def update_waiting(self, state: "GameState"):
        ...
        if (distance < 40 and state.controller.confirm_button and \
            ...
            if Events.WHEEL_OF_TORTURE_VANESSA_BLACK_DEFEATED.value in state.player.level_four_npc_state:
    ...
    def update_talking(self, state: "GameState"):
        ...
        if (current_message.is_finished() and Events.WHEEL_OF_TORTURE_VANESSA_BLACK_DEFEATED.value
            ...
            if selected_option == "Yes" and state.player.stamina_points > 0 and state.player.money >= 50:
                ...
                state.currentScreen = state.wheelOfTortureVanessaBlackScreen
                state.wheelOfTortureVanessaBlackScreen.start(state)

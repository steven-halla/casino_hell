...
##
##
class SirLeopoldTheHedgeHogHotelRoom(Npc):
    def __init__(self, x: int, y: int):
        super().__init__(x, y)
        self.textbox = NpcTextBox(
            ["My bed sucks, it's like the entire bed is made out of bed bugs....I feel woozy",
        ...
        self.character_sprite_image = pygame.image.load(
            "/images/DS DSi - The World Ends With You - Hedge Hado Coa (1).png").convert_alpha()

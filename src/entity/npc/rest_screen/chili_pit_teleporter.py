...
class ChiliPitTeleporter(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.flipping_ted_messages = {
            ...
            "defeated_message": NpcTextBox(
                ["I smell chili, I'm here to gamble not eat, maybe later when I'm hungry."],
                (50, 450, 700, 130), 36, 500)
        }
        self.choices = ["Yes", "No"]
        self.menu_index = 0
    ...
    def draw(self, state):
        ...
        if self.state == "talking":
            ...
            if state.player.hasRabies == False and state.player.rabiesImmunity == False:

...
class April(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.nelly_opossum_messages = {
            ...
            ["April Ewwwwww get away from me you poor bastard and get at least 150 coins, you disgust me!"],
            (50, 450, 700, 130), 36, 500),
            "rabies_message": NpcTextBox(
                ["April Awwwww are you ok? Don't you worry your pretty little head I'll give you home, real soon like. Do you love garbage? Your gonna."],
                (50, 450, 700, 130), 36, 500),
        }
        self.choices = ["Yes", "No"]
        self.menu_index = 0

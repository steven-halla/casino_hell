...
class CoinFlipBetty(Npc):
    ...
    def update_talking(self, state: "GameState"):
        ...
        if current_message.is_finished() and current_message.message_at_end() and state.controller.isTPressed and Events.COIN_FLIP_BETTY_DEFEATED.value not in state.player.level_two_npc_state:

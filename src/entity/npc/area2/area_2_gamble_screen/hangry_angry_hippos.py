...
class HangryAngryHippos(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.hippo_messages = {
            "welcome_message": NpcTextBox(
                ["HIppo: Are you sure you want to battle the king of hippos?"],
                (50, 450, 700, 130), 36, 500),
            "defeated_message": NpcTextBox(
                ["Hippo: How, impossible, nobody has every defeated my double hippo technique."],
                (50, 450, 700, 130), 36, 500),
    ...
    def update_waiting(self, state: "GameState"):
        ...
        if (distance < 40 and state.controller.confirm_button and \
            ...
            # in future will need TICKET item

    ...
    def __init__(self, x: int, y: int):
        ...
        self.black_jack_thomas_messages = {
            "welcome_message": NpcTextBox(
                ["Erika:Tadaaa are you surprised? Yeah I'm the boss....what kind of deal were you wanting to make hero? I already know what I want when you lose.",
                ...
                # "You have to be my slave, forever. I'm going to make you do so many horrible things for me ho ho ho, you'll become my plaything.",

...
class MikeTalk(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.mike_talk_messages = {
            ...
            "quest_complete_message": NpcTextBox(
                ["Mike: Thank you for defeating that cheating rotten bastard. You have given us all hope."],
                (50, 450, 700, 130), 36, 500),
    ...
    def update_waiting(self, state: "GameState"):
        ...
        if (distance < 40 and state.controller.confirm_button and \
            ...
            if Events.COIN_FLIP_TED_DEFEATED.value in state.player.level_one_npc_state:
                self.mike_talk_messages["defeated_message"].reset()
    ...
    def update_talking(self, state: "GameState"):
        current_message = (
            self.mike_talk_messages["defeated_message"]
            if Events.COIN_FLIP_TED_DEFEATED.value in state.player.level_one_npc_state
            else self.mike_talk_messages["welcome_message"]
        )

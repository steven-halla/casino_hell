...
class CoinFlipFred(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.coin_flip_fred_messages = {
            "welcome_message": NpcTextBox(
                ["Fred: Are you sure you want to battle the king of COIN FLIP?"],
                (50, 450, 700, 130), 36, 500),
            "defeated_message": NpcTextBox(
                ["Fred: How, impossible, nobody has every defeated my double flip technique."],
                (50, 450, 700, 130), 36, 500),
    ...
    def update_waiting(self, state: "GameState"):
        ...
        if (distance < 40 and state.controller.confirm_button and \
            ...
            if Events.COIN_FLIP_FRED_DEFEATED.value in state.player.level_one_npc_state:
    ...
    def update_talking(self, state: "GameState"):
        ...
        if (current_message.is_finished() and Events.COIN_FLIP_FRED_DEFEATED.value

...
class HangryAngryHipposBeff(Npc):
    def __init__(self, x: int, y: int):
        ...
        self.craps_happy_messages = {
            "welcome_message": NpcTextBox(
                ["beff: Are you sure you want to battle the king of  hippo ?"],
                (50, 450, 700, 130), 36, 500),
            "defeated_message": NpcTextBox(
                ["Diena: How, impossible, nobody has every defeated my double  hippo technique."],
                (50, 450, 700, 130), 36, 500),
    ...
    def update_waiting(self, state: "GameState"):
        ...
        if (distance < 40 and state.controller.confirm_button and \
            ...
            if Events.HANGRY_ANGRY_HIPPOS_BEFF.value in state.player.level_three_npc_state:
    ...
    def update_talking(self, state: "GameState"):
        ...
        if (current_message.is_finished() and Events.HANGRY_ANGRY_HIPPOS_BEFF.value

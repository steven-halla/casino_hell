    ...
    def __init__(self, x: int, y: int):
        ...
        self.craps_happy_messages = {
            "welcome_message": NpcTextBox(
                ["billy bob: Are you sure you want to battle the king of opossum in a can   ?"],
                (50, 450, 700, 130), 36, 500),
            "defeated_message": NpcTextBox(
                ["billy bob: How, impossible, nobody has every defeated my double opossum technique."],
                (50, 450, 700, 130), 36, 500),
    ...
    def update_waiting(self, state: "GameState"):
        ...
        if (distance < 40 and state.controller.confirm_button and \
            ...
            if Events.OPOSSUM_IN_A_CAN_BILLY_BOB_DEFEATED.value in state.player.level_three_npc_state:
                ...
                self.craps_happy_messages["welcome_message"].reset()

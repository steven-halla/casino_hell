...
class CrapsJunpon(Npc):
    def __init__(self, x: int, y: int):
        super().__init__(x, y)

        # Integrated textbox content into guy_messages
        self.selected_item_index = 0
        self.craps_junpon_messages = {
            "welcome_message": NpcTextBox(
                ["Junpon: Are you sure you want to battle the king of Craps?"],
                (50, 450, 700, 130), 36, 500),
            "defeated_message": NpcTextBox(
                ["Junpon: How, impossible, nobody has every defeated my craps."],
                (50, 450, 700, 130), 36, 500),

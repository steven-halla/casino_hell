...
class OpossumInACanSallyScreen(GambleScreen):
    def __init__(self, screenName: str = "Opossum in a can Billy Bob") -> None:
        ...
        self.battle_messages: dict[str, MessageBox] = {
            self.WELCOME_MESSAGE: MessageBox([
                "Sally: My Opossums sure are friendly, they wont bite you. They just wanna nibble."
            ]),
    ...
    def update(self, state):
        ...
        if self.game_state == self.LEVEL_UP_SCREEN:
            ...
            if self.player_score > self.sallyOpossumMoney:
                self.player_score = self.sallyOpossumMoney
    ...
    def draw_box_info(self, state: 'GameState'):
        ...
        state.DISPLAY.blit(self.font.render(f"{self.MONEY_HEADER} {self.sallyOpossumMoney}", True, WHITE), (player_enemy_box_info_x_position, enemy_money_y_position))

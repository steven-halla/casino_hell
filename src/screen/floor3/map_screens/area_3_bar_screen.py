...
from entity.npc.area3.area_3_bar_screen.area_3_bar_to_rest_door import Area3BarToRestDoor
from entity.npc.area3.area_3_bar_screen.area_3_barkeep import Area3BarKeep
...
# WHAT IF I CALL START AFTER EXITING A SCREEN TO CALL IMPORTANT FUNS WHILE NOT ALWAYS USING UPDATE
    ...
    def start(self, state: "GameState"):
        ...
        state.npcs = [
            ...
            Area3BarToRestDoor(16 * 30, 16 * 25),
            # Area1GamblingToMazeDoor(16 * 45, 16 * 40),
            Area3BarKeep(16 * 4, 16 * 5),

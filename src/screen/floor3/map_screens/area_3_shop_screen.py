...
from entity.npc.area3.area_3_shop_screen.area_3_shop_keeper import Area3ShopKeeper
from entity.npc.area3.area_3_shop_screen.area_3_shop_to_rest_door import Area3ShopToRestDoor
...
# WHAT IF I CALL START AFTER EXITING A SCREEN TO CALL IMPORTANT FUNS WHILE NOT ALWAYS USING UPDATE
    ...
    def start(self, state: "GameState"):
        ...
        state.npcs = [
            ...
            Area3ShopToRestDoor(16 * 30, 16 * 25),
            Area3ShopKeeper(16 * 11, 16 * 5),

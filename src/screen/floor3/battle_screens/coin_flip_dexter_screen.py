...
# have all coin flips be a 1-100 but if its 100% then set the value to 100
    def __init__(self, screenName: str = "Coin FLip") -> None:
        ...
        self.money: int = 999
        self.dexter_magic_points: int = 2
        ...
        self.debuff_money_balancer: int = 0
    ...
    def reset_round(self, state):
        ...
        match self.dexter_magic_points:
            case 2:
                money_balancer_randomizer = random.randint(1, 70) + self.money_balancer_chance - player_luck_bonus
            case 1:
                money_balancer_randomizer = random.randint(1, 50) + self.money_balancer_chance - player_luck_bonus




        if money_balancer_randomizer > 100 and self.dexter_magic_points > 0 and self.debuff_money_balancer == 0:

...
from entity.npc.area4.area_4_bar_screen.area_4_bar_to_rest_door import Area4BarToRestDoor
from entity.npc.area4.area_4_bar_screen.area_4_barkeep import Area4BarKeep
...
# WHAT IF I CALL START AFTER EXITING A SCREEN TO CALL IMPORTANT FUNS WHILE NOT ALWAYS USING UPDATE
    ...
    def start(self, state: "GameState"):
        ...
        state.npcs = [
            ...
            Area4BarToRestDoor(16 * 30, 16 * 25),
            # Area1GamblingToMazeDoor(16 * 45, 16 * 40),
            Area4BarKeep(16 * 4, 16 * 5),

...
from entity.npc.area4.area_4_shop_screen.area_4_shop_keeper import Area4ShopKeeper
from entity.npc.area4.area_4_shop_screen.area_4_shop_to_rest_door import Area4ShopToRestDoor
...
# WHAT IF I CALL START AFTER EXITING A SCREEN TO CALL IMPORTANT FUNS WHILE NOT ALWAYS USING UPDATE
    ...
    def start(self, state: "GameState"):
        ...
        state.npcs = [
            ...
            Area4ShopToRestDoor(16 * 30, 16 * 25),
            Area4ShopKeeper(16 * 11, 16 * 5),

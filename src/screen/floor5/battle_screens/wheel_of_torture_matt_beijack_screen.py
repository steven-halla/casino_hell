...
class WheelOfTortureMattBeijackScreen(GambleScreen):
    def __init__(self, screenName: str = "wheel of torturett"):
        ...
        self.dealer_name: str = "Matt Beijack"
        ...
        self.battle_messages: dict[str, MessageBox] = {
            self.WELCOME_SCREEN_MESSAGE: MessageBox([
                "Matt Beijack: this is the welcome screen"
            ]),
    ...
    def update(self, state):
        ...
        if self.player_win_token >= 3:
            ...
            Events.add_level_five_event_to_player(state.player, Events.WHEEL_OF_TORTURE_MATT_BEIJACK_DEFEATED)

...
class PokerCodyScreen(GambleScreen):
    def __init__(self, screenName: str = "poker_darnel"):
        ...
        self.battle_messages: dict[str, MessageBox] = {
            self.WELCOME_MESSAGE: MessageBox([
                "Welcome to Poker! I'm Cody, your dealer today.",
    ...
    def update(self, state):
        ...
        #---------------------enemy logic below
            ...
            if state.controller.confirm_button:
                ...
                self.cody_money -= self.enemy_bet
                self.game_state = self.WELCOME_SCREEN
                self.restart_poker_round()
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    def draw_box_info(self, state: 'GameState'):
        ...
        state.DISPLAY.blit(self.font.render(f"{self.MONEY_HEADER}: {self.cody_money}", True, WHITE),

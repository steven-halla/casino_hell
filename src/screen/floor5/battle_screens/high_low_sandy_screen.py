...
class HighLowSandyScreen(GambleScreen):
    def __init__(self, screenName: str = "high low") -> None:
        ...
        self.countdown_rot_chance: int = 0

        self.battle_messages: dict[str, MessageBox] = {
            self.WELCOME_MESSAGE: MessageBox([
                "Sandy: This is the welcome screen"
            ]),
    ...
    def build_custom_26_card_deck(self):
        ...
        if self.buff_red_card_only_in_deck == False and self.debuff_countdown_rot == 0:
        ...
        elif self.buff_red_card_only_in_deck == False and self.debuff_countdown_rot > 0:
            allowed_suits = ["Hearts", "Clubs"]
            allowed_ranks = [2, 3, 4, 5, 6, 7, 8, 9, 10, "Jack", "Queen", "King", "Ace"]
        ...
        elif self.buff_red_card_only_in_deck == True and self.debuff_countdown_rot == 0:
        ...
        elif self.buff_red_card_only_in_deck_cost == True and self.debuff_countdown_rot > 0:
            allowed_suits = ["Hearts"]
            allowed_suits_rot = ["Hearts", "Clubs", "Spades", "Diamonds"]
            allowed_ranks = [2, 3, 4, 5, 6, 7, 8, 9, 10, "Jack", "Queen", "King", "Ace"]
            allowed_ranks_rot = [2]
    ...
    def reset_spread_no_ace(self, state):
        ...
        self.player_hand: list = []
        self.enemy_hand: list = []
        self.countdown_rot_chance += 3

        count_down_rot_randomizer = random.randint(1, 100) + self.countdown_rot_chance

        if count_down_rot_randomizer > 90 and self.cody_magic_points > 0 and self.debuff_countdown_rot == 0:
            self.current_screen = self.CODY_CASTING_SPELL_SCREEN
            self.countdown_rot_chance = 0

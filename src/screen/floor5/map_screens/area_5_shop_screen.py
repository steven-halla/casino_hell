...
from entity.npc.area5.area_5_shop_screen.area_5_shop_keeper import Area5ShopKeeper
from entity.npc.area5.area_5_shop_screen.area_5_shop_to_rest_door import Area5ShopToRestDoor
...
# WHAT IF I CALL START AFTER EXITING A SCREEN TO CALL IMPORTANT FUNS WHILE NOT ALWAYS USING UPDATE
    ...
    def start(self, state: "GameState"):
        ...
        #     state.treasurechests = [
        #         Area5MoneyBag(16 * 97, 14 * 55),
        #     ]
        #
        # if state.player.perception >= 2 and Treasure.FOCUS_BOOST.value not in state.player.level_two_npc_state:
        #     state.treasurechests.append(Area5FocusBoost(16 * 111, 14 * 111))

        state.npcs = [

            Area5ShopToRestDoor(16 * 30, 16 * 25),
            Area5ShopKeeper(16 * 11, 16 * 5),

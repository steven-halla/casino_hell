...
from entity.npc.area5.area_5_boss_screen.area_5_boss_to_gambling_screen import Area5BossToGamblingDoor
...
# WHAT IF I CALL START AFTER EXITING A SCREEN TO CALL IMPORTANT FUNS WHILE NOT ALWAYS USING UPDATE
    ...
    def start(self, state: "GameState"):
        ...
        state.npcs = [
            ...
            Area5BossToGamblingDoor(16 * 30, 16 * 25),

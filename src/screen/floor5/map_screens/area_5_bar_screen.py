...
from entity.npc.area5.area_5_bar_screen.area_5_bar_to_rest_door import Area5BarToRestDoor
from entity.npc.area5.area_5_bar_screen.area_5_barkeep import Area5BarKeep
...
# WHAT IF I CALL START AFTER EXITING A SCREEN TO CALL IMPORTANT FUNS WHILE NOT ALWAYS USING UPDATE
    ...
    def start(self, state: "GameState"):
        ...
        state.npcs = [
            ...
            Area5BarToRestDoor(16 * 30, 16 * 25),
            # Area1GamblingToMazeDoor(16 * 45, 16 * 40),
            Area5BarKeep(16 * 4, 16 * 5),

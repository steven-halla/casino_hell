...
from constants import SCREEN_WIDTH, SCREEN_HEIGHT, WINDOWS_SIZE, TILE_SIZE, \
    GREEN, BLUEBLACK, BLUE, RED, PLAYER_OFFSET
...
class MainScreen(Screen):
    ...
    def __init__(self):
        ...
        self.tiled_map = pytmx.load_pygame(
            "/Users/stevenhalla/documents/images/casinomaingame.tmx")
...
class CoinFlipTedScreen(Screen):
    ...
    def draw(self, state: "GameState"):
        ...
        DISPLAY.blit(
            ...
            (10, 10))
        DISPLAY.blit(self.font.render(f"{self.second_message_display}", True,
                                      (255, 255, 255)), (10, 50))
        DISPLAY.blit(self.font.render(f"{self.third_message_display}", True,
                                      (255, 255, 255)), (10, 230))
        DISPLAY.blit(self.font.render(f"Your current bet is:{self.bet}", True,
                                      (255, 255, 255)), (10, 260))
        DISPLAY.blit(
            self.font.render(f"player health:{state.player.stamina_points}",
                             True, (255, 255, 255)), (10, 290))
        DISPLAY.blit(
            self.font.render(f"player magic:{state.player.focus_points}", True,
                             (255, 255, 255)), (10, 320))
        ...
        if self.game_state == "bet_screen":
            ...
            DISPLAY.blit(self.font.render(f"^", True, (255, 255, 255)),
                         (240, 235))
            DISPLAY.blit(self.font.render(f"v", True, (255, 255, 255)),
                         (240, 288))
            ...
            DISPLAY.blit(
                self.font.render(f"{self.yes_or_no_menu[0]}", True,
                                 (255, 255, 255)),
                (700, 160))

            DISPLAY.blit(
                self.font.render(f"{self.yes_or_no_menu[1]}", True,
                                 (255, 255, 255)),
                (700, 210))
...
class OpossumInACanScreen(Screen):
    ...
    def draw(self, state: "GameState"):
        ...
        if self.game_state == "choose_can":
            ...
            DISPLAY.blit(self.font.render(f"press T", True, (255, 255, 255)),
                         (10, 10))
        elif self.game_state == "choose_can":
            DISPLAY.blit(self.font.render(f"Press 1 to choose  a opossum", True,
                                          (255, 255, 255)), (100, 10))



        elif self.game_state == "play_again_or_bail":
            DISPLAY.blit(self.font.render(f"your result is {self.result}", True,
                                          (255, 255, 255)), (388, 50))
        ...
        if self.game_state == "player_1_declare_intent_stage":
            ...
            DISPLAY.blit(
                self.diceFont.render(f"Player 2 Pile: {self.player2pile}", True,
                                     (255, 255, 255)), (300, 300))
            DISPLAY.blit(self.diceFont.render(f"Ante: {self.ante}", True,
                                              (255, 255, 255)), (400, 400))
            ...
            DISPLAY.blit(self.diceFont.render(f"Player 1 is going cold. ", True,
                                              (255, 255, 255)), (10, 10))
            DISPLAY.blit(
                self.diceFont.render(f"Player 1 Pile: {self.player1pile}", True,
                                     (255, 255, 255)), (200, 200))
            ...
            DISPLAY.blit(
                self.diceFont.render(f"Player 1 Money: {state.player.money}",
                                     True, (255, 255, 255)), (155, 100))
            DISPLAY.blit(
                self.diceFont.render(f"Player 2 Pile: {self.player2pile}", True,
                                     (255, 255, 255)), (155, 200))
            DISPLAY.blit(
                self.diceFont.render(f"Player 2 Money: {self.chiliWilleyMoney}",
                                     True, (255, 255, 255)), (155, 300))
            DISPLAY.blit(self.diceFont.render(f"Ante: {self.ante}", True,
                                              (255, 255, 255)), (155, 400))
            DISPLAY.blit(
                self.diceFont.render(f"Player 2 wins", True, (255, 255, 255)),
                (155, 500))
            ...
            DISPLAY.blit(
                self.diceFont.render(
                    ...
                    (255, 255, 255)),
                (155, 255))
            DISPLAY.blit(self.diceFont.render(f" {self.roll_state}", True,
                                              (255, 255, 255)), (5, 355))
            if self.player_1_lost_game == True:
                DISPLAY.blit(
...
class Deck:
    ...
    def face_down_card(self, position: tuple[int, int]):
        ...
        sprite = self.sprite_sheet.subsurface(
            pygame.Rect(top_card_position, (self.card_width, self.card_height)))
    ...
    def show_card(self, suit: str, value: str, position: tuple[int, int]):
        ...
        card_position = (
        x_offset * self.card_width, y_offset * self.card_height)
        sprite = self.sprite_sheet.subsurface(
            pygame.Rect(card_position, (self.card_width, self.card_height)))
        sprite.set_colorkey((0, 190, 0))
        DISPLAY.blit(sprite, position)
...
class BlackJackScreen(Screen):
    ...
    def draw(self, state: "GameState"):
        ...
        DISPLAY.blit(self.font.render(f"Money: {state.player.money}", True,
                                      (255, 255, 255)), (37, 250))
        DISPLAY.blit(
            self.font.render(f"HP: {state.player.stamina_points}", True,
                             (255, 255, 255)), (37, 290))

        DISPLAY.blit(self.font.render(f"MP: {state.player.focus_points}", True,
                                      (255, 255, 255)), (37, 330))
        DISPLAY.blit(
            self.font.render(f"Bet: {self.bet}", True, (255, 255, 255)),
            (37, 370))

        DISPLAY.blit(self.font.render(f"Hero", True, (255, 255, 255)),
                     (37, 205))
        ...
        DISPLAY.blit(self.font.render(f"Money: {self.cheater_bob_money}", True,
                                      (255, 255, 255)), (37, 70))
        DISPLAY.blit(self.font.render(f"Status: {self.enemy_status}", True,
                                      (255, 255, 255)), (37, 110))

        if self.reveal_hand < 11:
            DISPLAY.blit(self.font.render(f"Score: {self.enemy_score}", True,
                                          (255, 255, 255)),
                         (37, 150))
        elif self.reveal_hand > 10:
            DISPLAY.blit(self.font.render(f"Score:", True, (255, 255, 255)),
                         (37, 150))

        DISPLAY.blit(self.font.render(f"Cheater Bob", True, (255, 255, 255)),
                     (37, 30))
        ...
        if self.game_state == "welcome_screen":
            ...
            if self.magic_lock == False:
                ...
                DISPLAY.blit(self.font.render("Locked", True, (255, 255, 255)),
                             (680, 315))
            ...
            DISPLAY.blit(self.font.render(f"Your Current bet:{self.bet}", True,
                                          (255, 255, 255)), (50, 530))
            DISPLAY.blit(self.font.render(f"v", True, (255, 255, 255)),
                         (260, 550))
            DISPLAY.blit(self.font.render(f"^", True, (255, 255, 255)),
            ...
            for i, card in enumerate(self.player_hand):
                if i > 3:
                    player_card_y = 305
                    player_card_x = 235
                self.deck.show_card(card[1], card[0],
            ...
            if self.avatar_of_luck == True and self.redraw_lock == False:
                DISPLAY.blit(self.font.render("Redraw", True, (255, 255, 255)),
                             (687, 360))
            ...
            # DISPLAY.blit(character_image, (23, 245))
            DISPLAY.blit(self.font.render(f"{self.current_speaker}", True,
                                          (255, 255, 255)), (155, 350))
            ...
            DISPLAY.blit(
                self.font.render(f"{self.second_message_display}", True,
                                 (255, 255, 255)), (45, 450))
            DISPLAY.blit(self.font.render(f"{self.first_message_display}", True,
                                          (255, 255, 255)), (45, 500))
